...
<body>
    ...
    <!-- Quiz Container -->
    <div class="container">
        <p class="question">What should be considered when choosing a disinfectant?</p>
        <div id="answers">
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">The scent of the product</button>
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">The colour of the disinfectant</button>
            <button class="btn" onclick="validateMCQ(this, 'correct')">Its effectiveness against specific pathogens and required contact time</button>
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">Whether it has a decorative container</button>
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">Whether it is the cheapest option available</button>
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">If it can be used once and remain effective indefinitely</button>
        </div>
        <p id="feedback"></p>
    ...
    <script>
        function validateMCQ(button, correctness) {
            ...
            if (correctness === "correct") {
                ...
                setTimeout(() => {
                    window.location.href = "{{ route('coreone.five') }}"; // Redirect to Question 5
                }, 2000);
            } else {
