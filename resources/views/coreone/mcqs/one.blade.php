...
<body>
    ...
    <div class="container">
      <p class="question">Which statement is true about pathogens?</p>
      <div id="answers">
          <button class="btn" onclick="validateMCQ(this, 'incorrect')">
              A) All bacteria are harmful
          </button>
          <button class="btn" onclick="validateMCQ(this, 'incorrect')">
              B) Viruses can reproduce on their own
          </button>
          <button class="btn" onclick="validateMCQ(this, 'correct')">
              C) Some microorganisms cause infections, while others are harmless or beneficial
          </button>
          <button class="btn" onclick="validateMCQ(this, 'incorrect')">
              D) Pathogens only exist in hospitals
          </button>
          <button class="btn" onclick="validateMCQ(this, 'incorrect')">
              E) Infection control is unnecessary for workplaces outside of healthcare
          </button>
          <button class="btn" onclick="validateMCQ(this, 'incorrect')">
              F) All infections can be treated with antibiotics
          </button>
      </div>
      <p id="feedback"></p>
  ...
  <script>
        function validateMCQ(button, correctness) {
            ...
            if (correctness === "correct") {
                ...
                setTimeout(() => {
                    window.location.href = "{{ route('coreone.two') }}"; // Redirect to Question 2
                }, 2000);
            } else {
