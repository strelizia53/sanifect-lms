...
<body>
    ...
    <div class="container">
        <p class="question">
            What is a key requirement for disinfectants used on food contact surfaces?
        </p>
        <div id="answers">
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">
                Leaving a strong fragrance on all cleaned surfaces
            </button>
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">
                Needing a very long contact time (over 30 minutes)
            </button>
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">
                Being cheap and highly perfumed
            </button>
            <button class="btn" onclick="validateMCQ(this, 'correct')">
                Ensuring they are non-toxic and leave no harmful residues
            </button>
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">
                Only being used when surfaces are visibly dirty
            </button>
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">
                Providing permanent sterility with a single application
            </button>
        </div>
        <p id="feedback"></p>
    ...
    <script>
        function validateMCQ(button, correctness) {
            ...
            if (correctness === "correct") {
                ...
                setTimeout(() => {
                    window.location.href = "{{ route('coreone.eight') }}"; // Redirect to Question 8
                }, 2000);
            } else {
