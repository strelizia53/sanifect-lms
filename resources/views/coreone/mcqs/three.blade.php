...
<body>
    ...
    <!-- Quiz Container -->
    <div class="container">
        <p class="question">Why is cleaning necessary before disinfection?</p>
        <div id="answers">
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">It makes surfaces look shiny</button>
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">It reduces the need for disinfectants</button>
            <button class="btn" onclick="validateMCQ(this, 'correct')">It removes organic matter that may shield pathogens from disinfectants</button>
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">It eliminates the need for PPE</button>
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">Cleaning alone is enough to kill all bacteria and viruses</button>
            <button class="btn" onclick="validateMCQ(this, 'incorrect')">Disinfectants work instantly, regardless of surface contamination</button>
        </div>
        <p id="feedback"></p>
    ...
    <script>
        function validateMCQ(button, correctness) {
            ...
            if (correctness === "correct") {
                ...
                setTimeout(() => {
                    window.location.href = "{{ route('coreone.four') }}"; // Redirect to Question 4
                }, 2000);
            } else {
