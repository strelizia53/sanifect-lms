...
<html lang="en">
  ...
  <body>
    <div class="container">
      <p class="question">
        Which best describes the role of PPE in infection control?
      </p>
      <div id="answers">
        <button class="btn" onclick="validateMCQ(this, 'incorrect')">
          Enhances pathogen spread
        </button>
        <button class="btn" onclick="validateMCQ(this, 'incorrect')">
          Eliminates the need for disinfection
        </button>
        <button class="btn" onclick="validateMCQ(this, 'correct')">
          Protects individuals from infection exposure
        </button>
        <button class="btn" onclick="validateMCQ(this, 'incorrect')">
          Reduces need for hygiene
        </button>
      </div>
      <p id="feedback"></p>
    </div>
    ...
    <script>
      function validateMCQ(button, correctness) {
        ...
        if (correctness === "correct") {
          ...
          setTimeout(() => {
            window.location.href = '{{ route('modules.index') }}'; // Redirect to Question 2
          }, 2000);
        } else {
