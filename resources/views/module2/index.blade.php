...
<html lang="en">
  <head>
    ...
    <title>Slideshow with Audio</title>
    <!-- Swiper.js CSS -->
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <div class="button-container">
      ...
      <button
        class="quiz-button"
        onclick="window.location.href = '{{ route('module2.one') }}'"
      >
        Go to Quiz
      </button>
    </div>
    ...
    <script>
      ...
      const slides = [
        ...
        { image: "8.jpg", audio: "8.mp3" },
        { image: "9.jpg", audio: "9.mp3" },
      ];

      const imageFolder = "{{ asset('module2/moduleSlides') }}";
      const audioFolder = "{{ asset('module2/moduleAudio') }}";
