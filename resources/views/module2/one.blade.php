...
<html lang="en">
  ...
  <body>
    <div class="container">
      <p class="question">Why is infection control important?</p>
      <div id="answers">
        ...
        <button class="btn" onclick="validateMCQ(this, 'correct')">
          To prevent disease spread and reduce healthcare costs
        </button>
        <button class="btn" onclick="validateMCQ(this, 'incorrect')">
          To eliminate all microorganisms
        </button>
        <button class="btn" onclick="validateMCQ(this, 'incorrect')">
          To allow pathogen growth
        </button>
      </div>
      <p id="feedback"></p>
    </div>
    ...
    <script>
      function validateMCQ(button, correctness) {
        ...
        if (correctness === "correct") {
          ...
          setTimeout(() => {
            window.location.href = '{{ route('module2.two') }}'; // Redirect to Question 2
          }, 2000);
        } else {
