...
<html lang="en">
  ...
  <body>
    <div class="container">
      <p class="question">Which is not a key IPC measure?</p>
      <div id="answers">
        ...
        <button class="btn" onclick="validateMCQ(this, 'correct')">
          Increasing patient exposure to pathogens
        </button>
        <button class="btn" onclick="validateMCQ(this, 'incorrect')">
          Using PPE
        </button>
    ...
    <script>
      function validateMCQ(button, correctness) {
        ...
        if (correctness === "correct") {
          ...
          setTimeout(() => {
            window.location.href = '{{ route('module2.three') }}'; // Redirect to Question 2
          }, 2000);
        } else {
