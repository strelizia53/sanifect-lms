...
<html lang="en">
  ...
  <body>
    <div class="container">
      <p class="question">
        Which of the following mechanisms do pathogens use to make us sick?
      </p>
      <div id="answers">
        ...
        <button class="btn" onclick="validateMCQ(this, 'correct')">
          Producing toxins or invading cells
        </button>
        <button class="btn" onclick="validateMCQ(this, 'incorrect')">
          Boosting immunity
        </button>
    ...
    <script>
      function validateMCQ(button, correctness) {
        ...
        if (correctness === "correct") {
          ...
          setTimeout(() => {
            window.location.href = '{{ route('module3.two') }}'; // Redirect to Question 2
          }, 2000);
        } else {
