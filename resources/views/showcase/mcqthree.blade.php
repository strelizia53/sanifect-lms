...
<html lang="en">
  ...
  <body>
    <div class="container">
      <p class="question">
        It is necessary to remove chewing gum from under the seats and table
        tops when misting with Nanocyn. True or False?
      </p>
      <div>
        <button class="btn" onclick="validateMCQ(this, 'correct')">True</button>
    ...
    <script>
      function validateMCQ(button, correctness) {
        ...
        if (correctness === "correct") {
          ...
          setTimeout(() => {
            window.location.href = "{{ route('quiz.mcq4') }}"; // Redirect to mcqfour.html
